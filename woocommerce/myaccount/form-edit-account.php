	...
	<div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
		<div>
			...
			<p class="woocommerce-form-row woocommerce-form-row--first form-row form-row-first">
				<label class="uppercase text-sm font-normal tracking-wide" for="account_first_name">
			...
			<p class="woocommerce-form-row woocommerce-form-row--last form-row form-row-last">
				<label class="uppercase text-sm font-normal tracking-wide" for="account_last_name">
			...
			<p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
				<label class="uppercase text-sm font-normal tracking-wide" for="account_display_name">
				...
				<span><em class="not-italic text-sm text-gray-500">
			...
			<p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
				<label class="uppercase text-sm font-normal tracking-wide" for="account_email">
					<?php esc_html_e('Email address', 'woocommerce'); ?>&nbsp;<span class="required">*</span>
				</label>
				<input type="email"
					class="woocommerce-Input woocommerce-Input--email input-text w-full px-4 py-2 tracking-wide border text-sm rounded-none h-10"
		...
		<fieldset>
			...
			<p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
				<label class="uppercase text-sm font-normal tracking-wide" for="password_current">
					<?php esc_html_e('Current password (leave blank to leave unchanged)', 'woocommerce'); ?>
				</label>
				<input type="password"
					class="woocommerce-Input woocommerce-Input--password input-text w-full px-4 py-2 tracking-wide border text-sm rounded-none h-10"
