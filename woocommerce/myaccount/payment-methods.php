...
<?php if ( WC()->payment_gateways->get_available_payment_gateways() ) : ?>
	<div class="flex justify-end">
		<div>
			<a class="button flex items-center justify-center alt wc-forward w-full bg-secondary px-4 py-2 h-12 text-white text-center transition-all duration-200 hover:bg-primary disabled:opacity-20 uppercase tracking-wide rounded-lg text-sm" href="<?php echo esc_url( wc_get_endpoint_url( 'add-payment-method' ) ); ?>"><?php esc_html_e( 'Add payment method', 'woocommerce' ); ?></a>
		</div>
	</div>
<?php endif; ?>
