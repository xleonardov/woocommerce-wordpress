...
<form method="post" class="woocommerce-ResetPassword lost_reset_password font-roboto">
  <div class="flex flex-col max-w-screen-sm mx-auto space-y-4  py-4 my-4">
    ...
    <p class="woocommerce-form-row woocommerce-form-row--first form-row form-row-first">
        ...
        <input type="password" class="woocommerce-Input woocommerce-Input--text input-text w-full px-4 py-2 tracking-wide border text-xs rounded-none h-10" name="password_1"
    ...
    <p class="woocommerce-form-row woocommerce-form-row--last form-row form-row-last">
        ...
        <input type="password" class="woocommerce-Input woocommerce-Input--text input-text w-full px-4 py-2 tracking-wide border text-xs rounded-none h-10" name="password_2"
