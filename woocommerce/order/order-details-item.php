...
<tr
	...
	<td class="woocommerce-table__product-name product-name text-base tracking-wide font-roboto">
		<?php
		$is_visible = $product && $product->is_visible();
		$imageUrl = null;
		if ($product->get_type() === 'variation') {
			$parent_prd = wc_get_product($product->get_parent_id());
			$imageUrl = wp_get_attachment_image_url($parent_prd->get_image_id(), 'full');
		} else {
