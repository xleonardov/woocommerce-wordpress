...
<div class="shop_table woocommerce-checkout-review-order-table w-full bg-[#EAEAEA] bg-opacity-25 p-4">
	<h3 id="order_review_heading" class="uppercase text-sm font-semibold tracking-wide mb-4">
	...
	<table class="w-full">
		...
		<tfoot>
			...
			<tr class="order-total  border-t">
				<th class="text-left pt-2 uppercase text-base tracking-wide">
