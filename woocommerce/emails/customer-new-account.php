...
<p>
	<?php printf('Obrigado por criar uma conta em %1$s. O seu utilizador é: %2$s.', esc_html($blogname), '<strong>' . esc_html($user_login) . '</strong>'); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>
</p>
