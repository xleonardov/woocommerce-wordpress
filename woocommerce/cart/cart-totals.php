...
?>
<div
	class="cart_totals font-roboto <?php echo (WC()->customer->has_calculated_shipping()) ? 'calculated_shipping' : ''; ?>">

	<?php do_action('woocommerce_before_cart_totals'); ?>

	<h2 class="uppercase text-xl font-semibold tracking-wide font-roboto">
	...
	<table cellspacing="0" class="shop_table shop_table_responsive w-full my-4">
		...
		<tr class="order-total border-t border-b">
			<th class="text-left pt-4 uppercase text-base tracking-wide pb-4">
